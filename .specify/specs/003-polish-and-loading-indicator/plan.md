# Implementation Plan: Polish & Loading Indicator

**Branch**: `003-polish-and-loading-indicator` | **Date**: 2026-09-04 | **Spec**: [spec.md](spec.md)

## Summary

Refactor the podcast-player codebase to complete Phase 6 polish: add loading indicators to refresh buttons, migrate SettingsScreen to Riverpod, clean up repository patterns, inject DownloadService via providers, and migrate from deprecated RadioListTile to RadioGroup.
...
- Must not break existing unit tests (101 tests)

**Scale/Scope**: 6 screens, 4 repositories, 4 services
...
| Test-First Development | ✅ Pass | Existing 101 unit tests cover repositories & use cases |
| User Experience First | ✅ Pass | Loading indicator directly benefits UX |
...
```text
specs/003-polish-and-loading-indicator/
├── plan.md              # This file
